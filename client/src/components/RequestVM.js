...
function RequestVM() {
  const handleSubmit = async (event) => {
    ...
    if (a==0 || b==0 || c==0 || d==0 || e==0 || f==0) {
      ...
      await axios.post("/medicine").then((res)=>{
        if(res){
    ...
    <div>
      <div class="wrap-contact100">
        ...
        >
          ...
          <label class="label-input100" for="first-name">
            Enter Medicine Required *
          </label>
          <div
            class="wrap-input100 rs1-wrap-input100 validate-input"
            data-validate="Enter Medicine"
          >
            <input
              id="second-name"
              class="input100"
              type="text"
              name="medicine"
              placeholder="Enter Medicine Required"
              data-validate="Enter Medicine"
            />
            <span class="focus-input100"></span>
          </div>
